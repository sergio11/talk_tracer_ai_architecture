...
namespace :talktracerai do 
    ...
    task :create_apache_airflow_users do
        ...
        create_executor_user_cmd = "docker exec #{container_name} airflow users create -r User -u api_executor -e api_executor@talktracerai.com -f API -l Executor -p dreamsoftware00"
    ...
    task :build_and_push_airflow_image do
      image_name = "ssanchez11/talk_tracer_ai_apache_airflow:0.0.1"
